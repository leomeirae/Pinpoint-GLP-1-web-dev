...
export default function CostsScreen() {
    ...
    const summary = useMemo(() => {
        ...
        return { totalCost, costPerWeek, costPerKg };
                ...
                <>
                    <View style={[styles.summaryCard, { backgroundColor: colors.card }]}>
                        <View style={styles.summaryItem}>
                            ...
                            <Text style={[styles.summaryValue, { color: colors.text }]}>R$ {summary.totalCost.toFixed(2)}</Text>
                        </View>
                        <View style={styles.summaryItem}>
                            <Text style={[styles.summaryLabel, { color: colors.textSecondary }]}>Custo / Semana</Text>
                            <Text style={[styles.summaryValue, { color: colors.text }]}>R$ {summary.costPerWeek.toFixed(2)}</Text>
                        </View>
                        <View style={styles.summaryItem}>
                            <Text style={[styles.summaryLabel, { color: colors.textSecondary }]}>Custo / kg perdido</Text>
                            <Text style={[styles.summaryValue, { color: colors.text }]}>R$ {summary.costPerKg.toFixed(2)}</Text>
                        </View>
                    </View>
...
const styles = StyleSheet.create({
    ...
    summaryLabel: { ...ShotsyDesignTokens.typography.caption },
